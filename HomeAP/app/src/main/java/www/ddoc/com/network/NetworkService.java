...
import www.ddoc.com.update.UpdatePostData;
import www.ddoc.com.update.UpdatePostResult;
import www.ddoc.com.update.UpdateResult;
...
public interface NetworkService {
    ...
    @GET("fcm")
    Call<UpdateResult> getUpdateReg();
    @POST("fcm/lock")
    Call<UpdatePostResult> getUpdatePostReg(@Body UpdatePostData updatePostData);
    @POST("blocklist")
