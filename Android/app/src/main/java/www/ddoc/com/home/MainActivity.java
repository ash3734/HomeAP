...
import www.ddoc.com.deviceAdd.AddDeviceFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentMain = new MainFrament();
        fragmentAddDevice = new AddDeviceFragment();
        fragmentSetting = new Fragment();
...
//    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            transaction.replace(R.id.container,fragmentAddDevice);
